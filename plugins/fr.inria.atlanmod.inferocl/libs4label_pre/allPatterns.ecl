...
:-lib(lists).
:-lib(ech).
%:-use_module("libs/ocl_basicops.ecl").
%:-use_module("libs/ocl_collections.ecl").
%:-use_module("libs/ocl_iterators.ecl").
%:-use_module("libs/uml_basic.ecl").
%:-use_module("libs/inv_pattern.ecl").
