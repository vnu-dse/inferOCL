...
{
	some  o : Classifier.name | size[o]>5
}
...
//No specific criteria to generate a model
//run nothing for 20
run Classifier_name_partition1 for 20
//A ClassModel with at least 5 classes
//run  mfAllRanges_ClassModel_classifier_partition3 for 20
//A ClassModel with a Classes with no parent, one parent, or more than 5 parents
run mfAllPartitions_Class_parent_partition1_Class_parent_partition2_Class_parent_partition3 for 20
