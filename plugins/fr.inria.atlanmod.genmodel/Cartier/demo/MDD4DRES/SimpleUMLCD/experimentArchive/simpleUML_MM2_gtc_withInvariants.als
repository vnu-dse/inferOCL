...
{
	some  o : Classifier |size[o.name] = 0
}
pred Classifier_name_partition2

{
	some  o : Classifier |size[o.name] = 1
}
pred Classifier_name_partition3

{
	some  o : Classifier |size[o.name] >= 5
}
pred Association_name_partition1

{
	some  o : Association |size[o.name] = 0
}
pred Association_name_partition2

{
	some  o : Association |size[o.name] = 1
}
pred Association_name_partition3

{
	some  o : Association |size[o.name] >= 5
}
...
{
	some  o : Attribute |size[o.name] = 0
}
pred Attribute_name_partition2

{
	some  o : Attribute |size[o.name] = 1
}
pred Attribute_name_partition3

{
	some  o : Attribute |size[o.name] >= 5
}
...
pred GenerateAndTestCustom

{

}
run GenerateAndTestCustom  for  20 Classifier, 20 Association, 20 Attribute, 20 Class, 20 PrimitiveDataType, 20 ClassModel, 5 int , 5 String, 5 seq 
