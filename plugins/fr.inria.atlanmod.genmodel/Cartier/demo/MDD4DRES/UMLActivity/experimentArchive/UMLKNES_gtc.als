...
run GenerateAndTestCustom  for  20 Activity, 20 ActivityNode, 20 ControlNode, 20 ActivityFinalNode, 20 InitialNode, 20 ActivityEdge, 20 ControlFlow, 20 DecisionNode, 20 Action, 20 AcceptEventAction, 20 ValueSpecification, 20 NamedElement, 20 RedefinableElement, 20 Trigger, 20 Event, 20 ExecutionEvent, 20 CreationEvent, 20 DestructionEvent, 5 int , 5 seq , 5 String
