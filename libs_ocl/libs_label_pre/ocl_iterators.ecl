...
ocl_col_any(_, _, oclUndefined, _, oclUndefined).
  ...
  (
    (
     ...
     ( 
       ...
       foreach(TmpValue, TmpResult),
 
       param(Property, Instances, Vars, Defined)

       do(

         apply(Property, [Instances, [Elem|Vars], TmpValue]), 

         ( TmpValue = oclUndefined
           -> Defined = 0;
           Defined = 1
         )
...
list_is_unique(oclUndefined, oclUndefined).
...
qsort_apply(_, _, oclUndefined, _, oclUndefined).
